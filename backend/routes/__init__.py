...
from .auth_routes import router as auth_router, set_controller as set_auth_controller

__all__ = ['formdata_router', 'set_formdata_controller', 'storeinfo_router', 'set_storeinfo_controller', 'statistics_router', 'set_statistics_controller', 'auth_router', 'set_auth_controller']
